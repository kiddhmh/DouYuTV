...
@objc public protocol TagListViewDelegate {
    @objc optional func tagPressed(_ title: String, tagView: MHTagView, sender: MHTagListView) -> Void
    @objc optional func tagRemoveButtonPressed(_ title: String, tagView: MHTagView, sender: MHTagListView) -> Void
}

@IBDesignable
open class MHTagListView: UIView {
    ...
    @IBInspectable open dynamic var paddingY: CGFloat = 8 {
        didSet {
            for tagView in tagViews {
    ...
    @IBInspectable open dynamic var paddingX: CGFloat = 8 {
        didSet {
            for tagView in tagViews {
    ...
    open private(set) var tagViews: [MHTagView] = []
    ...
    private func createNewTagView(_ title: String) -> MHTagView {
        let tagView = MHTagView(title: title)
    ...
    @discardableResult
    open func addTag(_ title: String) -> MHTagView {
        return addTagView(createNewTagView(title))
    }
    
    @discardableResult
    open func addTags(_ titles: [String]) -> [MHTagView] {
        var tagViews: [MHTagView] = []
        for title in titles {
    ...
    @discardableResult
    open func addTagViews(_ tagViews: [MHTagView]) -> [MHTagView] {
        for tagView in tagViews {
    ...
    @discardableResult
    open func insertTag(_ title: String, at index: Int) -> MHTagView {
        return insertTagView(createNewTagView(title), at: index)
    }
    
    @discardableResult
    open func addTagView(_ tagView: MHTagView) -> MHTagView {
    ...
    @discardableResult
    open func insertTagView(_ tagView: MHTagView, at index: Int) -> MHTagView {
    ...
    open func removeTagView(_ tagView: MHTagView) {
    ...
    open func selectedTags() -> [MHTagView] {
        return tagViews.filter() { $0.isSelected == true }
    }
    
    // MARK: - Events
    
    func tagPressed(_ sender: MHTagView!) {
        sender.onTap?(sender)
        delegate?.tagPressed?(sender.currentTitle ?? "", tagView: sender, sender: self)
    }
    
    func removeButtonPressed(_ closeButton: MHCloseButton!) {
